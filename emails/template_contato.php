                    ...
                    <tr>
                        <td width="100%" bgcolor="#ffffff" style="text-align:left;">
                            <p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; margin-top:0; margin-bottom:15px; padding:0; font-weight:normal;">
                                Email não aparece corretamente? <a style="color:#2489B3; font-weight:bold; text-decoration:underline;" href="#">Veja em seu navegador.</a>
                            </p>
                            <p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; margin-top:0; margin-bottom:15px; padding:0; font-weight:normal;">
                                Copyright 2018 Fisio evol. Todos os direitos reservados.<br>
                                Se deseja não receber mais os emails <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="#">clique aqui</a>.
                            </p>
                        </td>
                    </tr>
                </table>
